...
const embeddedDataTarget2 =
    'flagged';  // This is the name of the embedded data field where the boolean
                // flag for inappropriate questions will be stored

// Only change this if you know what you're doing
const chatbotUrl = 'https://corporate-sight-empire-discs.trycloudflare.com/chat'; // This is the URL of the chatbot.
...
function receiveMessage(msg) {
	...
	dialogue = JSON.stringify(msg.data); // questions
	flagged = JSON.stringify(msg.data); // responses
